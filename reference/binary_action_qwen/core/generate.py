...
from dvr_qwen.core.attention import forward_decode_text, forward_text_only, forward_visual_read
from dvr_qwen.core.cache import DVRCache
from dvr_qwen.core.input_builder import DVRInputs, build_dvr_inputs
from dvr_qwen.core.masks import make_text_causal_mask, make_visual_read_mask
from dvr_qwen.model.modeling_dvr_qwen2_5_vl import DVRLayerStats, DVRQwen2_5_VLForConditionalGeneration
...
def dvr_prefill(
    ...
    cache = DVRCache(num_layers=model.config.text_config.num_hidden_layers)
